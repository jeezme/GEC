...
def _build_html() -> str:
    ...
    recent_dons = db.get_recent_dons(10000)
    ...
    card12_body = (
        ...
        '<div class="versus-side">'
        '<div class="side-title" style="color:#e91e8c">&#9792; FILLES</div>'
        '<div style="font-size:.9em;color:#888;margin-top:4px">Don moyen</div>'
        '<div style="font-size:2em;font-weight:900;color:#e91e8c;margin-bottom:4px">' + _fmt(avg_f) + '</div>'
        ...
        '<div class="side-title" style="color:#3498db">&#9794; GARÇONS</div>'
        '<div style="font-size:.9em;color:#888;margin-top:4px">Don moyen</div>'
        '<div style="font-size:2em;font-weight:900;color:#3498db;margin-bottom:4px">' + _fmt(avg_m) + '</div>'
