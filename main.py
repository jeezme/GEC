...
def _build_html() -> str:
    ...
    js = (
        ...
        "btn.disabled=false;btn.textContent='" + chr(128248) + " Enregistrer';"
        "}).catch(function(err){"
        ...
        "}).catch(function(err2){"
        "document.body.removeChild(clone);"
        "console.error(err2);btn.disabled=false;btn.textContent='" + chr(128248) + " Enregistrer';"
        "});"
        "});},2000);"
        "}else{"
        ...
        "btn.disabled=false;btn.textContent='" + chr(128248) + " Enregistrer';"
        "}).catch(function(err){"
        "console.error(err);btn.disabled=false;btn.textContent='" + chr(128248) + " Enregistrer';"
        "});}"
        "}"
    )
